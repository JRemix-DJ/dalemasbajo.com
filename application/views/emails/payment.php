              ...
              <th class="column mobile-8" width="255" style="padding-left: 10px; padding-right: 10px; font-weight: 400; text-align: left;">
                <div class="serif" style="color: #1F2225; font-size: 16px; font-weight: 700; margin-bottom: 20px;">
                  ...
                  <? if($item->gender_id==45){ ?>
                   <? echo '<p style="color: red; font-style: italic; font-size: 14px;">Debes enviar un correo a dalemasbajo@gmail.com con tu frase y el número de orden para poder hacer la entrega. Se enviará tu producto en 24 a 48 horas (excepto en feriados).</p>'; ?>
                  <? } ?>
                </div>
