            ...
            <tr>
              <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; text-align: left;">
                <a href="http://example.com" style="text-decoration: none;">
                  <img class="mobile-center" src="http://localhost/dalemasbajo.com/images/logo.png" width="105" alt="Dale Más Bajo" style="border: 0; width: 100%; max-width: 105px;">
                </a>
              </th>
            </tr>
            <tr>
                ...
                <table class="row" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <th class="column" width="640" style="text-align: left;">
                      ...
                      <div class="sans-serif" style="color: #969AA1; font-size: 18px; font-weight: 400; line-height: 28px; margin-bottom: 20px;">Por motivos de seguridad se ha modificado tu contraseña de acceso a DALEMASBAJO.COM</div>
                    </th>
                  </tr>
                </table>
              </th>
          ...
          <table class="row" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
            ...
            <tr class="mobile-valign-top">
              <td style="padding: 20px; font-size: 16px; ">
                  A continuación te presentamos tus nuevos credenciales de acceso:<br><br>
                 <strong>
                  E-mail: <? echo $email; ?><br>
                  Password: <? echo $password; ?><br>
                  </strong>
                  <i>* Si deseas cambiar este password recuerda no usar tu contraseña anterior.</i>
              </td>
            </tr>
            <tr>
              <td class="spacer" height="80" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
                ...
                <table class="row" cellpadding="0" cellspacing="0">
                  <tr valign="top" style="vertical-align: top;">
                    <th class="column mobile-6" width="200" style="padding-right: 10px; color: #969AA1; font-weight: 400; text-align: left;">
                      <div class="sans-serif" style="font-size: 14px; font-weight: 700; margin-bottom: 15px;">Dale Más Bajo</div>
                    </th>
