        ...
        <div class="form-layout">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-control-label">Portada (Cover)</label>
                            <input type="file" name="featured_image" class="form-control" accept="image/png,image/jpeg,image/webp">

                            <?php if(!empty($producto->featured_image)){ ?>
                                <div class="mg-t-10">
                                    <div class="mg-b-5"><strong>Portada actual:</strong></div>
                                    <img
                                            src="<?php echo base_url().$producto->featured_image; ?>"
