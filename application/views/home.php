...
<head>
    ...
    <link rel="shortcut icon" href="<?= base_url('assets/front/img/icons/favicon.ico'); ?>">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Montserrat:wght@500;600;700;800&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Oswald:wght@300;400;500;600;700&display=swap" rel="stylesheet">

    <link rel="stylesheet" href="<?= base_url('assets/front/css/newhomeblue.css?v=' . (file_exists(FCPATH.'assets/front/css/newhomeblue.css') ? filemtime(FCPATH.'assets/front/css/newhomeblue.css') : time())) ?>">
    ...
    <meta property="og:image" content="<?= base_url('assets/front/img/dj_new.jpg'); ?>" />
...
<section class="home-hero">
    <video class="home-hero-video" autoplay muted loop>
        <source src="<?= base_url('assets/uploads/video_banners/new_video.mp4'); ?>" type="video/mp4">
    </video>
</section>
<section class="home">
    <div class="content">
        <a href="<?= base_url(); ?>"
           class="absolute top-6 right-6 z-20 inline-flex items-center rounded-xl px-5 py-3">
            <img class="h-10 md:h-14 lg:h-16 w-auto"
                 src="<?= base_url('assets/front/img/logo_horizontal.png?v=1.2'); ?>"
                 alt="<?= $title; ?>">
        </a>
...
<div class="container mx-auto px-4 mt-10">
    <div class="mb-12">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="<?= base_url('audios').'#trending'; ?>"
                ...
                foreach($plans as $plan){
                    ...
                    <div class="<?= $container_classes; ?>">
                        ...
                        <div class="<?= $inner_classes; ?>">
                            ...
                            <ul class="space-y-4 mb-8 flex-1">
                                <li class="flex items-start">
                                    ...
                                    <span class="ml-3 text-slate-700 font-medium">
                                        <?php if ($plan->ilimitado_activo == 1) { ?>
                                            <span class="text-primary font-bold">Unlimited Audio Downloads</span>
                                        <?php } else { ?>
                                            <span class="font-bold"><?= ($plan->tokens != 0 && $plan->tokens != NULL) ? $plan->tokens : '0'; ?></span> Audio Downloads
                                        <?php } ?>
                                    </span>
                                </li>
                                ...
                                <?php if($show_request_remix){ ?>
                                    <li class="flex items-start">
                                        <div class="flex-shrink-0 w-6 h-6 rounded-full bg-blue-50 flex items-center justify-center mt-0.5">
                                            <i class="fa fa-check text-primary text-xs"></i>
                                        </div>
                                        <span class="ml-3 text-slate-700 font-semibold">
                                            <span class="text-primary font-extrabold"><?= htmlspecialchars($request_remix_label, ENT_QUOTES, 'UTF-8'); ?></span>
                            ...
                            <a href="<?= $btn_href; ?>" <?= $btn_attrs; ?>
                               class="w-full block text-center py-4 rounded-xl font-bold transition-all duration-200 transform hover:-translate-y-1 <?= $btn_class; ?>">
                                Get Plan
                            </a>
